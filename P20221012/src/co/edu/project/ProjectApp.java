		...
		while (true) {
			...
			while (true) {
				...
				if (menu == 1) {
					...
					while (true) {
						System.out.println("1. 직원등록 2.직원수정 3.직원삭제 4.직원목록 5.상세조회 9.종료");
						System.out.println(">>>");
					...
					while (true) {
						System.out.println("============================================");
						System.out.println("1.연차등록 2.연차조회 3.연차상세조회 4.연차사용 5.종료");
						System.out.println("============================================");
						System.out.println(">>> ");
						int submenu = scn.nextInt();
						if (submenu == 1) {
					...
					while (true) {
						System.out.println("========================================================");
						System.out.println("1.직원등록 2.금일근태관리 3.총근무시간조회 4.월초근무시간초기화 5.종료");
						System.out.println("========================================================");
						System.out.println(">>> ");
						int submenu = scn.nextInt();
						scn.nextLine();
					...
					System.out.println("1.직원목록 2.연차목록 3.근무목록");
